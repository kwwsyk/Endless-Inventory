...
public abstract class ClientPayloadHandler {
    ...
    public static void handleEndInvSettings(SyncedConfig syncedConfig, IPayloadContext iPayloadContext){
        ...
        player.setData(ModInitializer.SYNCED_CONFIG,syncedConfig);
